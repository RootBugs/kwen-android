...
import io.github.jan.supabase.auth.Auth  // TODO: edge case
...
val supabase: SupabaseClient = createSupabaseClient(  // FIXME: validation
    supabaseUrl = SUPABASE_URL,  // optimize: validation
